...
const ChatProfile = (props) => {
  ...
  return (           
    <div class="card w-full bg-base-100 shadow-xl h-full">
        <figure><img src={accountData?.userDetail?.profile_picture === "" ? "https://api.lorem.space/image/face?w=150&h=150" : accountData?.userDetail?.profile_picture} alt="profile picture" className={`w-96 ${totalMessage.at(0) >=5 && totalMessage.at(1) >=5 ? "" : "blur"}`}/></figure>
        <div class="card-body">
